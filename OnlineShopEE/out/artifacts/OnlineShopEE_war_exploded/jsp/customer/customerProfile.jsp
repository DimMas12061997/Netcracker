...
<%--<div class="container">--%>
    <%--<form action="controller" method="POST" class="form" id="profile-form">--%>
        <%--<h3 class="form-title">Основное</h3>--%>
        <%--<div class="message js-form-message"></div>--%>
        <%--<input type="hidden" name="command" value="editprofile" />--%>
        <%--<div class="form-group">--%>
            <%--<input type="email" placeholder="Ваш e-mail" name="email" class="form-input">--%>
        <%--</div>--%>
        <%--<div class="form-group">--%>
            <%--<input type="text" placeholder="Ваш адрес" name="address" class="form-input">--%>
        <%--</div>--%>
        <%--<div class="form-group">--%>
            <%--<input type="text" placeholder="Ваш бюджет" name="budget" class="form-input">--%>
        <%--</div>--%>
        <%--<div class="form-group">--%>
            <%--<input type="text" placeholder="Номер кредитной карточки" name="credit_card" class="form-input">--%>
        <%--</div>--%>
        <%--<div class="form-group">--%>
